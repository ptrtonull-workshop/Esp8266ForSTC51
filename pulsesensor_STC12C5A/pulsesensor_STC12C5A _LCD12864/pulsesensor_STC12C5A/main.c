...
unsigned char code ucStr1[]  =  "Pulsesensor test";		//显示信息1
unsigned char code ucStr2[]  =  "                ";		//显示信息2
unsigned char code ucStr3[]  =  "  BPM:          ";		//显示信息3
unsigned char code ucStr4[]  =  "作者:anning86525";		//显示信息4
  ...
  sys_init();
	...
	while(1)
	{
		...
		if (QS == true){                       // Quantified Self flag is true when arduino finds a heartbeat
					...
					LCD_disp_list_char(3,4,DisBuff);//在LCD12864上显示BPM
			 }
